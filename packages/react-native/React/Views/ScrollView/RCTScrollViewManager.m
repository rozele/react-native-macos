...
RCT_EXPORT_NOT_OSX_VIEW_PROPERTY(automaticallyAdjustKeyboardInsets, BOOL)
RCT_EXPORT_NOT_OSX_VIEW_PROPERTY(decelerationRate, CGFloat)
RCT_EXPORT_NOT_OSX_VIEW_PROPERTY(endDraggingSensitivityMultiplier, CGFloat)
...
RCT_EXPORT_OSX_VIEW_PROPERTY(isInvertedVirtualizedList, BOOL) // [macOS]
